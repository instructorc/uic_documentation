...
| :--- | :----:      |    :----:   |          :----: |
|1     | **Aug. 23rd** <br /> **Topic:** Syllabus Review, Pre-Assessment, Survey   | **Aug. 25th** <br /> **Topic:**  Web App Overview (Web Architecture), Final Project Review <br /> <br /> **Reading:** [Understanding Web Arch.](https://docs.microsoft.com/en-us/dotnet/architecture/modern-web-apps-azure/common-web-application-architectures) | **Aug. 27th** <br /> **Topic:** Threat Modeling (Various Models, DFD's) <br /> **Reading:** [OWASP Threat Modeling Cheatsheet](https://cheatsheetseries.owasp.org/cheatsheets/Threat_Modeling_Cheat_Sheet.html)  |
