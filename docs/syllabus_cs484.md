...
|6     | **Sept. 27th** <br /> **Topic:** Routing, Express, HTTP Verbs <br /> **Reading:** [Express Explained](https://www.freecodecamp.org/news/express-explained-with-examples-installation-routing-middleware-and-more/) <br />  | **Sept. 29th** <br /> **Topic:** Authentication and Authorization <br /> **Reading:** [Best Practices - Authentication + Password Management](https://cloud.google.com/blog/products/identity-security/account-authentication-and-password-management-best-practices) <br /> **Reading/Resource:** [The Ultimate Guide to Passport JS](https://dev.to/zachgoll/the-ultimate-guide-to-passport-js-k2l)| **Oct. 1st** <br /> **Topic:** Sessions, Cookies and Tokens <br /> **Reading:** [Using HTTP Cookies](https://developer.mozilla.org/en-US/docs/Web/HTTP/Cookies) <br /> **Reading/Resource:** [The Ultimate Guide to Passport JS](https://dev.to/zachgoll/the-ultimate-guide-to-passport-js-k2l) <br /> **Released:** Assignment 2 |
